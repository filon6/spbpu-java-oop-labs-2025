...
## Условия лабораторных Весна

## Лабораторная 1: Многопоточность. Supervisor

``Создать супервизор (управляющую программу), которая контролирует  
исполнение абстрактной программы. Абстрактная программа работает в отдельном потоке и является  
...
## Лабораторная 2: Многопоточность. Очереди сообщений
